...
# Copy dan paste kode ini untuk menggantikan bagian RESPONSE di script Anda
RESPONSE = b'HTTP/1.1 200 Websocket_openvpn\r\nContent-length: 0\r\nHTTP/1.1 101 Switching Protocols\r\n\r\n'
RESPONSE += b'HTTP/1.1 301 Switching Protocols\r\nUpgrade: websocket\r\nConnection: Upgrade\r\n\r\n'
RESPONSE += b'HTTP/1.1 69 Connection Established\r\n\r\n'
...
class ConnectionHandler(threading.Thread):
    ...
    def run(self):
        try:
            ...
            # Decode buffer ke string untuk mencari header

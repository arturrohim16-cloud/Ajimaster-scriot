...
cd /root/
# Tambahkan link download jika belum ada
xraycore_link="https://github.com/XTLS/Xray-core/releases/latest/download/Xray-linux-64.zip"
...
# // Membuat Konfigurasi Nginx Full Protokol
cat > /etc/nginx/conf.d/xray.conf <<EOF
server {
    listen 80;
    listen [::]:80;

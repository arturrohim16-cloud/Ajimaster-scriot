...
echo -e "  ${BICyan}[${BIWhite}04${BICyan}] TROJAN      ${WB}[${GB}${tr}${WB}]${NC}      │  ${BICyan}[${BIWhite}09${BICyan}] RESTART${NC}" 
echo -e "  ${BICyan}[${BIWhite}05${BICyan}] SHADOWSOCKS ${WB}[${GB}${ss}${WB}]${NC}      │  ${BICyan}[${BIWhite}21${BICyan}] CLEAR LOG${NC}"   
echo -e " ${BICyan} ╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯${NC}"
echo -e " ${BICyan} ╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮${NC}"
echo -e "  ${BICyan}[${BIWhite}11${BICyan}] ADD HOST/DOMAIN${NC}       │  ${BICyan}[${BIWhite}16${BICyan}] SPEEDTEST${NC}" 
echo -e "  ${BICyan}[${BIWhite}12${BICyan}] RENEW CERT${NC}            │  ${BICyan}[${BIWhite}17${BICyan}] CHECK BANDWIDTH${NC}"       
echo -e "  ${BICyan}[${BIWhite}13${BICyan}] EDIT BANNER${NC}           │  ${BICyan}[${BIWhite}18${BICyan}] LIMIT SPEED${NC}" 
echo -e "  ${BICyan}[${BIWhite}14${BICyan}] RUNNING STATUS${NC}        │  ${BICyan}[${BIWhite}19${BICyan}] WEBMIN${NC}" 
